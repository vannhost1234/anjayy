...
app.get("/", (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "login.html");
...
app.get("/dashboard", requireAuth, (req, res) => {
    const filePath = path.join(__dirname, 'vannhosting', 'dashboard.html');
...
app.get("/tools", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "tools.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) {
...
app.get("/profile", requireAuth, (req, res) => {
    const filePath = path.join(__dirname, 'vannhosting', 'profil.html');
...
app.get("/tiktok", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "tiktok-downloader.html");
  fs.readFile(filePath, "utf8", (err, html) => {
...
app.get("/tiktok2", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "tiktok.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/pin", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "pinterest.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/music", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "search-music.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/stats", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "stats.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/support", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "my-supports.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/sender", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "sender.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/yt", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "YouTube.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/ddos", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "ddos.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/anime", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "anime.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/grup", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "chatpublic.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/hentai", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "nsfw.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/wifi", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "wifi.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/fix", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "fixjs.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/ai", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "miyakoai.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/slot", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "slot.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/casino", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "casino.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/game", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "game.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/block", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "puzzle.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/stalk", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "stalk.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get("/ig-dl", requireAuth, (req, res) => {
  const filePath = path.join(__dirname, "vannhosting", "reels.html");
  fs.readFile(filePath, "utf8", (err, html) => {
    if (err) return res.status(500).send("❌ File tidak ditemukan");
    res.send(html);
  });
...
app.get('/spam', (req, res) => {
    ...
    res.sendFile(path.join(__dirname, 'vannhosting', 'telegram-spam.html'));
});
...
app.get("/ngl-spam", requireAuth, (req, res) => {
  ...
  const filePath = path.join(__dirname, "vannhosting", "spam-ngl.html");
...
<head>
    ...
    <style>
        * {
        ...
        :root {
            --bg-dark: #07030a;
            --card-bg: #111a11; /* Dark green tint */
            --accent-pink: #32ff7e; /* Apple Lime Green */
            --accent-purple: #3ae374; /* Darker Lime */
            --text-main: #ffffff;
            --text-dim: #a1a1aa;
